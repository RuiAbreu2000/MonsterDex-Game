...
public class bugDungeon extends Fragment implements View.OnTouchListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_bug_dungeon, container, false);
        image = v.findViewById(R.id.MapHolder);

        // Build map
        viewModel.getMap("bugDungeon");
        // Get Monster Matrix
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if(tile == 17){     // Go Home
            ...
            if(viewModel.getLevel() == 16){
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, bugDungeon, "DUNGEON").commit();
